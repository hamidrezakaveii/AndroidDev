...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText txtSAlaire, txtNom;
    ...
    private void setListeners() {
        btnCalculer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myIntent = new Intent(MainActivity.this, DestinationActivity.class);
                myIntent.setAction(Intent.ACTION_SEND);
                myIntent.putExtra("nom",nom);
                myIntent.putExtra("salaire", salaire);
                ...
                Toast.makeText(MainActivity.this, "Nom" + nom, Toast.LENGTH_LONG).show();
            }
        });
